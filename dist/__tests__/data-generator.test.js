...
class TestActivity extends data_generator_1.TrainingActivity {
}
describe('TrainingActivity Classes', () => {
    ...
    describe('Running Class', () => {
        it('should set discipline to "Running" and store distance', () => {
            const date = new Date();
            const runningActivity = new data_generator_1.Running(date, 'Morning Jog', 5);
    ...
    describe('Cycling Class', () => {
        it('should set discipline to "Cycling" and store distance', () => {
            const date = new Date();
            const cyclingActivity = new data_generator_1.Cycling(date, 'Road Trip', 42);
    ...
    describe('Swimming Class', () => {
        it('should set discipline to "Swimming" and store distance', () => {
            const swimmingActivity = new data_generator_1.Swimming(new Date(), 'Pool Laps', 1.5);
